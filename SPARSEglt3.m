...
function y=sparseglt3(fn1,fn2,fn3,hiddenvar,var1,var2)
% SPARSEGLT3 Sparseglt for 3 functions
% SPARSEGLT3(fn1,fn2,fn3,hiddenvar,var1,var2) computes the common roots
...
glt=orth(rand(3));
maple('Sparse_GLT_shorthand_3',fn1,fn2,fn3,var1,var2,hiddenvar,glt);
y=invglt(solveresultant(mapleresultant('Sparse_GLT_shorthand_3_')),inv(glt));